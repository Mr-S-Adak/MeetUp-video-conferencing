...
const EmptySessions = () => {
  return (
    <div className="w-full bg-white/50 bacdrop-blur rounded-3xl p-12 xl:py-24 text-center border border-slate-100 shadow-sm flex flex-col items-center justify-center space-y-4">
