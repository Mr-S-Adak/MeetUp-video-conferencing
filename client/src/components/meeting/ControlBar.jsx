...
const ControlBar = ({
  ...
  return (
    <footer className="w-full bg-white/90 backdrop-blur-md border-t border-slate-200/80 px-6 py-4 flex items-center justify-between z-40 shadow-slate-200/50">
      {/* Left Info & Copy Link */}
        ...
        <button
          ...
          className={`p-3.5 rounded-2xl transition-all cursor-pointer border ${
            isChatOpen
              ...
              : "bg-slate-100 hover:bg-slate-200 text-slate-800 border-slate-300 shadoe-xs"
          }`}
          title="Toggle In-Meeting Chat"
        >
          <MessageSquareIcon claasName="w-5 h-5" />
