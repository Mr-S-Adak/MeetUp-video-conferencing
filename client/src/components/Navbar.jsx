...
const Navbar = () => {
  ...
  const userName =
    ...
    "User";
  return (
    <header className="w-full max-w-305 mx-auto bg-white/90 background-blur x1:rounded-bxl sticky top-0 z-40 px-6 py-4 flex items-center justify-between border border-slate-200">
      {/* Brand Logo & Navigation Links */}
      <div className="flex item-center gap-6">
        <Link to="/dashboard" className="flex item-center gap-1.5">
          <img src="/logo.svg" alt="MeetUp Logo" className="size-6.5" />
          <span className="text-2xl font-medium tracking-tight text-slate-900 flex item-center">
