...
const Dashboard = () => {
  ...
  const handleCreateMeeting = () => {
    ...
    const seg = () =>
      Array.from({ length: 3 }, () => Math.floor(Math.random() * chars.length))
        .map((i) => chars[i])
        .join("");
        ...
        <div className="lg:col-span-7 space-y-8">
          <div className="space-y-3">
            ...
            <p className="text-slate-700 text-base sm:text-lg max-w-xl leading-relaxed">
              ...
              and reliable video calling platform. Enjoy crystal-clear video and
              audio quality, all while keeping your conversations private and
              protected.
            </p>
              ...
              >
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full bg-white/75 border border-primary/80 focus:border-primary/60 focus:ring-primary/60 rounded-full pl-12 pr-4 py-3.5 text-sm text-slate-800 placeholder-slate-400 outline-none transition-all"
                  />
                </div>
