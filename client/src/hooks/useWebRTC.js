...
const useWebRTC = (_roomId, user, onMeetingEnded, _enabled = true) => {
  ...
  //   Initilize the local camera stream if available in browser
  const initLocalStream = useCallback(async () => {
    try {
      ...
      console.log("Mock WebRTC Error: Running in camera preview fallback mode");
    }
    return null;
  }, []);
